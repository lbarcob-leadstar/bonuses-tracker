...
function HeroMetricCard({
  ...
  return (
      <div className="tracker-hero-stat min-h-[90px] rounded-2xl p-2.5 md:p-4">
        <div className="flex h-full items-start gap-2.5 text-left md:items-center md:gap-3">
        {ringValue !== undefined ? (
          <div className="tracker-progress-ring" style={{ background: `conic-gradient(${accent} ${Math.max(0, Math.min(100, ringValue))}%, rgba(255,255,255,0.08) 0)` }}>
            ...
            <div className="tracker-hero-icon mt-0.5 md:mt-0" style={{ color: accent }}>
    ...
    <div className="min-h-screen casino-app-bg relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 relative z-10">
        <div className="mb-5 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="rounded-full px-4 py-2 text-sm font-semibold self-start md:self-auto" style={{ background: 'rgba(10, 16, 24, 0.96)', border: '1px solid rgba(255,255,255,0.12)', color: 'rgba(255,255,255,0.82)', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.03), 0 8px 18px rgba(0,0,0,0.18)' }}>
